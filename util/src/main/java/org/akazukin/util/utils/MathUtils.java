...
public class MathUtils {
    ...
    /**
     * Bring {@param value} closer to {@param base} by {@param percent}
     *
     ...
     * @return The maximum of {@param n}
     * @throws java.lang.IllegalArgumentException The length of {@param n} is 0
     */
    ...
    public static int max(final int... n) {
        if (n.length == 0) throw new IllegalArgumentException("The specified number length is 0");
        int max = n[0];
        for (final int v : n) max = Math.max(max, v);
        return max;
    }
     ...
     *
     * @param n The number of int
     * @return The minimum of {@param n}
     * @throws java.lang.IllegalArgumentException The length of {@param n} is 0
     */
    public static int min(final int... n) {
        if (n.length == 0) throw new IllegalArgumentException("The specified number length is 0");
        int min = n[0];
        for (final int v : n) min = Math.min(min, v);
        return min;
    }
    ...
    public static double max(final double... n) {
        if (n.length == 0) throw new IllegalArgumentException("The specified number length is 0");
        double max = n[0];
        for (final double v : n) max = Math.max(max, v);
        return max;
    }
    ...
    public static double min(final double... n) {
        if (n.length == 0) throw new IllegalArgumentException("The specified number length is 0");
        double min = n[0];
        for (final double v : n) min = Math.min(min, v);
        return min;
    }
    ...
    public static float max(final float... n) {
        if (n.length == 0) throw new IllegalArgumentException("The specified number length is 0");
        float max = n[0];
        for (final float v : n) max = Math.max(max, v);
        return max;
    }
    ...
    public static float min(final float... n) {
        if (n.length == 0) throw new IllegalArgumentException("The specified number length is 0");
        float min = n[0];
        for (final float v : n) min = Math.min(min, v);
        return min;
    }
    ...
    public static long max(final long... n) {
        if (n.length == 0) throw new IllegalArgumentException("The specified number length is 0");
        long max = n[0];
        for (final long v : n) max = Math.max(max, v);
        return max;
    }
    ...
    public static long min(final long... n) {
        if (n.length == 0) throw new IllegalArgumentException("The specified number length is 0");
        long min = n[0];
        for (final long v : n) min = Math.min(min, v);
        return min;
    }

    public static double formatDecimal(final double value, int decimalPoint) {
        final int dec = (int) Math.pow(10, decimalPoint);
        return (double) Math.round(value * dec) / dec;
    }

    public static float formatDecimal(final float value, int decimalPoint) {
        final int dec = (int) Math.pow(10, decimalPoint);
